import { generateConfirmationCode, monthNumberToAbbreviation, yenToUsd } from '../includes/helpers.js';
...
export const getTicketOptionsForRoute = async (routeId) => {
    ...
    return db().ticketClasses.map(tc => ({
        class: tc.class,
        name: tc.name,
        price: Math.round(yenToUsd(route.distance * tc.pricePerKm) * 100) / 100,
